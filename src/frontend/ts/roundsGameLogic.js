define(["require", "exports", "./util", "./rpc", "./powerups", "./logic", "./gameLogic", "./pp", "./eval", "esprima"], function (require, exports, util_1, rpc_1, powerups_1, logic_1, gameLogic_1, pp_1, eval_1, esprima_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class RoundsGameLogic extends gameLogic_1.BaseGameLogic {
        ...
        invSatisfiesPos(inv, data) {
            let pos_res = eval_1.invEval(inv.rawInv, this.curLvl.variables, data[0]);
            let hold = pos_res.filter(function (x) { return x; }).length;
            return hold === pos_res.length;
        }
        loadLvl(lvl) {
            let gl = this;
            let goodInvs = this.foundJSInv.filter((inv) => gl.invSatisfiesPos(inv, lvl.data));
    ...
    exports.RoundsGameLogic = RoundsGameLogic;
});
//# sourceMappingURL=roundsGameLogic.js.map