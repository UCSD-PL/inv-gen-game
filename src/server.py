...
def tryAndVerify(levelSet, levelId, invs):
    ...
    overfitted, nonind, sound, violations = tryAndVerify_impl(bbs, loop, initial_sound, boogie_invs)
    ...
    overfitted, nonind, sound_p2, violations = tryAndVerify_impl(bbs, loop, sound, p2_invs)
