...
p.add_argument('--email', type=str, default = "lerner@eng.ucsd.edu", help = "Email to notify")
args = parse_args(p)
...
while 1:
    ...
    if num_left == 0:
        ...
        send_notification(args.email, notification_subj, "All hits in experiment {0} are done.".format(args.ename))
        exit (0)
    else:
